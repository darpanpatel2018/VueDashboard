        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover" id="employee_table">
                <thead>
                 ...
                 <tbody id="tbody-tabla-convalidaciones"></tbody>
            </table>
			<div class="clearfix">
				...
				<form id="form-convalidaciones">
					...
					<div class="modal-body">
						<div class="form-group">
							<label>empId</label>
							     <input type="text" class="form-control" id="empId" placeholder="000000" required>
						</div>
						<div class="form-group">
							<label>Name</label>
						...
						<div class="form-group">
						  ...
						  <input type="date" class="form-control" id="dateOfBirth" placeholder="DD/MM/YY">
						</div>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
						<input type="submit" id="boton-enviar-convalidacion" class="btn btn-success" value="Add">
					</div>
				</form>
			</div>
		</div>
...
firebase.initializeApp(config)
                                var refConvalidaciones = firebase.database().ref().child('users/employee');
                                ...
                                function createEditConvalidacion(event) {
                                    ...
                                    switch (true) {
                                        case (modo === CREATE):
                                            ...
                                            var data = {
                                                empId: $('#empId').val(), //get the email from Form
                                                name: $('#name').val(), // get firstName
                                                ...
                                                if (passwords.password == passwords.cPassword) {
                                                    ...
                                                    firebase.auth()
                                                        ...
                                                        .then(function(user) {
                                                            ...
                                                            alert("Authenticated successfully with payload:", user.email);
                                                            auth = user;
